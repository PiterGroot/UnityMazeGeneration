...
public class MazeGenerator : MonoBehaviour {
    ...
    public void MakeExit()
    {
        ...
        mazeParent.transform.position += new Vector3(.5f, .5f, 0);
    ...
    private void OnDrawGizmos()
    {
        ...
        {
            Gizmos.DrawCube(cell.gridPos - new Vector2(mazeColumns / 2, mazeRows / 2), Vector3.one);
        }
        ...
        Gizmos.DrawCube(currentCell.gridPos - new Vector2(mazeColumns / 2, mazeRows / 2), Vector3.one);
    }
